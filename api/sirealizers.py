...
class CategorySirializer(serializers.ModelSerializer):
    class Meta:
        model = Category
        fields = ['id', 'item']


class TaskSerialializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = [
            'id', 'task', 'discription', 'criteria', 'status', 'status_name',
